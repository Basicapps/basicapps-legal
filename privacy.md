...
- **Subscription status** — Apple processes all subscription purchases through the App Store. We receive a receipt from Apple confirming your subscription status. We do not receive or store your payment card information.

### Device Permissions We Request
- **Face ID / Touch ID** — used solely to unlock the app. Biometric data is processed by Apple's system and never accessed or stored by us.
- **Camera** — used optionally to take a photo for a bank account logo. Photos are stored locally on your device only.
- **Photo Library** — used optionally to select an existing photo for a bank account logo. Photos are stored locally on your device only.
...
To cancel your subscription, manage it through your iPhone's Settings → Apple ID → Subscriptions.
